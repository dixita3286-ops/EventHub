...
.navbar{
    ...
    border-bottom:2px solid #ff9900;box-shadow:0 3px 20px rgba(255,153,0,0.3);z-index:2000
}
...
.menu-header{padding:18px 22px;border-bottom:1px solid rgba(255,255,255,.25)}
.close-btn{background:none;border:none;cursor:pointer}
#sideMenu a{
    padding:15px 22px;font-size:17px;color:white;display:block;
...
<div id="sideMenu">
    ...
    <a href="admin_events.php" class="active">Events</a>
