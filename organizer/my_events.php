...
.navbar{
    ...
    border-bottom:2px solid #ff9900;box-shadow:0 3px 20px rgba(255,153,0,0.3);z-index:3000;
}
.navbar-left img{height:40px;border-radius:6px}
.navbar-right{display:flex;align-items:center;gap:10px}

.navbar a{
    color:white;text-decoration:none;padding:6px 10px;border-radius:5px;font-size:14px;
}
...
#sideMenu{
    ...
    z-index:5000;box-shadow:-5px 0 20px rgba(0,0,0,0.5)
}
#sideMenu.show{ right:0; }

.menu-header{padding:18px 22px;border-bottom:1px solid rgba(255,255,255,0.25)}
.close-btn{background:none;border:none;cursor:pointer}

#sideMenu a{
    display:block;padding:15px 22px;font-size:17px;color:white;
    border-bottom:1px solid rgba(255,255,255,0.12);text-decoration:none;
}
#sideMenu a:hover{background:rgba(255,255,255,0.12)}
...
<!-- NAVBAR -->
<div class="navbar">
    <div class="navbar-left"><img src="../uploads/images/logo.png"></div>
